...
export class CategoriesService {
  ...
  listUrl: string = 'http://localhost:8081/categories/api/listCategories';
  categoriesUrl: string = 'http://localhost:8081/categories/api/listAll';
  createUrl: string = 'http://localhost:8081/categories/api/save';
  getUrl: string = 'http://localhost:8081/categories/api';
  updateUrl: string = 'http://localhost:8081/categories/api/update';
  deleteUrl: string = 'http://localhost:8081/categories/api/delete';
