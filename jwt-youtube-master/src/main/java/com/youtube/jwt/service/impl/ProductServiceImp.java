...
public class ProductServiceImp implements ProductService {
    ...
    public List<Product> listAll2(Long categoryId) {
        ...
        return productRepository.findAllByCategory(maybeCategory);
    }
 ...
 //       product.setPromotion(maybePromotion);
    ...
    @Override
    public Product update2(Long categoryId , Long productId , Product product, MultipartFile file) throws IOException {
        Product maybeProduct = productRepository.findByProductIdAndCategoryCategoryId(productId , categoryId)
                .orElseThrow(() -> {
                   throw new RuntimeException("this product with id " + productId
    ...
    public Product get2(Long productId , Long categoryId) {
        return productRepository.findByProductIdAndCategoryCategoryId(productId , categoryId)
                .orElseThrow(() -> {
                    throw new RuntimeException("this product is not found");
                });
    }
